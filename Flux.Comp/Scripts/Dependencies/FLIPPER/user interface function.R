...
# written by Laurine Burdorf (Laurine.Burdorf@uantwerpen.be)
#            Sebastiaan van de Velde (sevdevel@vub.ac.be)
# version 03 - date: 19/09/2019
#=========================================================

#=========================================================
# Changes made by Laurine since v2.0
#=========================================================

#=========================================================
# adaptions made by Seb since v1.0
...
source("./Scripts/Dependencies/FLIPPER/fittingfuncs/gradientfit v01.R")
source("./Scripts/Dependencies/FLIPPER/fittingfuncs/SavitskyGolay v01.R")
source("./Scripts/Dependencies/FLIPPER/fittingfuncs/profile v01.R")
...
h.min <- min(intervals)
if (h.min == 0) {
  h.min <- sort(intervals)[2]
  warning("Minimum interval detected is 0, second smallest interval used for calculation")}
